...

{
...

    {
        ...
        private Size normalSize = new Size(275, 350); 
        private Size crouchSize = new Size(275, 237); 
        ...
        private void FallenRuins_Load(object sender, EventArgs e)
        {
            ...
            groundLevel = this.ClientSize.Height - 40;
        ...
        private void FallenRuins_Load_2(object sender, EventArgs e)
